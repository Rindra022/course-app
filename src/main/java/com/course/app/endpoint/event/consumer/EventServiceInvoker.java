package com.course.app.endpoint.event.consumer;

import com.course.app.PojaGenerated;
import com.course.app.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("com.course.app.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "com.course.app.service.event."
